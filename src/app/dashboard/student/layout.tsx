    ...
    <div className="dashboard-layout">
      <aside className="sidebar glass-card">
        <div className="sidebar-header">
          ...
          <p className="role-badge">Student Portal</p>
        </div>
        
        <nav className="sidebar-nav">
          <Link href="/dashboard/student" className="nav-item active">
            <span>🏠</span> Home
          </Link>
          <Link href="/dashboard/student/quizzes" className="nav-item">
            <span>📝</span> My Exams
          </Link>
          <Link href="/dashboard/student/results" className="nav-item">
